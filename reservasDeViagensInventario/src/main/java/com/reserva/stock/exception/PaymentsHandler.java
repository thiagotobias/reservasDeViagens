...
@ControllerAdvice
public class PaymentsHandler extends ResponseEntityExceptionHandler {

    @ExceptionHandler(PaymentsException.class)
    public ResponseEntity<Object> handleEventNotFound(PaymentsException exception, WebRequest request) {
